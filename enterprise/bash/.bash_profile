...
alias gh.init='gh.cr.update && gh.patch && docker.login && gh.build && gh.start && gh.gw && gh.configure'
# alias gh.init='gh.cr.update && gh.patch && docker.login && gh.build && gh.start && gh.gw && gh.configure && gh.proxy'
...
alias gh.cr.update='(cd /workspace/enterprise2 && git stash && git fetch origin cr-subdomain-routes && git checkout cr-subdomain-routes)'
